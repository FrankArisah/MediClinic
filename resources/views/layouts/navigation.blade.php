            ...
            <div class="tab-pane active" id="menu">
                <nav class="sidebar-nav">
                    <ul class="main-menu metismenu">
                        ...
                        <li><a href="{{url ('addpatient')}}"><i class="fa fa-wheelchair"></i><span>Patients</span></a></li>
                        <li><a href="{{url ('adddoctor')}}"><i class="fa fa-user-md"></i><span>Doctors</span></a></li>
                        <li><a href="{{url ('doctorschedule')}}"><i class="fa fa-calendar-check-o"></i><span>Doctor Schedule</span></a></li>
