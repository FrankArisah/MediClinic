            ...
            <div class="tab-pane active" id="menu">
                <nav class="sidebar-nav">
                    <ul class="main-menu metismenu">
                        ...
                        <li><a href="{{url ('doctorschedulee')}}"><i class="fa fa-calendar-check-o"></i><span>Doctor Schedule</span></a></li>
                        <li><a href="{{url ('appointment')}}"><i class="fa fa-calendar"></i><span>Appointments</span></a></li>
