...
<div class="row clearfix">
  ...
  <div class="form-group col-sm-3">
    ...
    <!-- Default input -->
    <div class="form-group col-sm-3">
      <input mdbInput type="text" class="form-control" name="Number" id="Number" placeholder="Number">
    </div>
    <!-- Default input -->
    <div class="form-group col-sm-3">
      <input mdbInput type="text" class="form-control" name="LastVisit" id="LastVisit" placeholder="LastVisit">
    </div>
